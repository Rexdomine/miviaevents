  ...
  return (
    <section className="grid md:grid-cols-2 gap-12 items-center scroll-mt-32" id={id}>
      <div className={`space-y-6 ${reversed ? 'md:order-2' : 'md:order-1 order-2'}`}>
        ...
        <h3 className="text-4xl md:text-5xl font-light text-[#1b180d] dark:text-gray-900">{title}</h3>
        <p className="text-lg opacity-80 leading-relaxed italic text-[#1b180d]/80 dark:text-gray-900/80">
          {description}
        </p>
        <div className="grid grid-cols-2 gap-8 pt-4">
          <div>
            <h4 className="font-bold text-xs uppercase tracking-widest mb-3 text-primary">The Essentials</h4>
            <ul className="text-sm space-y-2 opacity-70 text-[#1b180d] dark:text-gray-900">
          ...
          <div>
            ...
            <p className="text-sm opacity-70 italic text-[#1b180d] dark:text-gray-900">{experience}</p>
          </div>
        </div>
        <div className="pt-6 flex items-center gap-6">
          ...
          <p className="text-xs opacity-50 uppercase tracking-widest text-[#1b180d] dark:text-gray-900">{price}</p>
        </div>
      </div>
