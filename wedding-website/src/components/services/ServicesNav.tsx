...
export default function ServicesNav() {
  return (
    <div className="sticky top-[73px] z-40 bg-background-light dark:bg-background-dark border-b border-primary/10 overflow-x-auto">
      <div className="max-w-7xl mx-auto px-6 py-4 flex gap-8 whitespace-nowrap justify-center text-xs font-bold uppercase tracking-[0.2em] text-[#1b180d] dark:text-gray-900">
