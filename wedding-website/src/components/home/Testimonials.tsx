    ...
    <section className="py-32 bg-background-light dark:bg-background-dark">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <FadeIn>
          ...
          <blockquote className="text-3xl md:text-4xl font-light leading-relaxed mb-12 italic text-[#1b180d] dark:text-gray-900">
              &ldquo;Mivia Events turned our vision into magic. Every detail was perfection!&rdquo;
          </blockquote>
        </FadeIn>
        <FadeIn delay={0.2}>
          <div className="flex flex-col items-center">
            ...
            <cite className="not-italic">
              <span className="block font-bold uppercase tracking-widest text-sm text-[#1b180d] dark:text-gray-900">Ada &amp; Chike</span>
