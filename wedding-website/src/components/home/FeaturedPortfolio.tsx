      ...
      <div className="max-w-7xl mx-auto">
        <FadeIn>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-16">
            ...
            <Link href="/portfolio" className="text-sm uppercase tracking-widest font-bold border-b border-primary pb-1 hover:text-primary transition-colors shrink-0">View All Works</Link>
          </div>
        </FadeIn>
