...
export default function InstagramFeed() {
  return (
    <section className="bg-white py-16 px-4 md:px-8">
      ...
      <div className="grid grid-cols-3 md:grid-cols-12 gap-2 md:gap-12 items-center max-w-7xl mx-auto py-20">

        {/* ── ROW 1 (top scatter) ── */}

        {/* Image 1 — tall portrait, pushed up */}
        <div className="col-span-1 md:col-span-4 md:col-start-1 md:-mt-20">
          <div className="relative w-full h-32 md:h-96 lg:h-[480px] overflow-hidden rounded-xl md:rounded-sm">
            <Image
        ...
        <div className="col-span-1 translate-y-6 md:translate-y-0 md:col-span-4 md:col-start-5 md:mt-12">
          <div className="relative w-full h-32 md:h-64 lg:h-72 overflow-hidden rounded-xl md:rounded-sm">
            <Image
        ...
        <div className="col-span-1 md:col-span-3 md:col-start-10 md:mt-24">
          <div className="relative w-full h-32 md:h-64 overflow-hidden rounded-xl md:rounded-sm">
            <Image
        ...
        <div className="col-span-3 md:col-span-12 flex flex-col items-center justify-center my-16 text-center">
          <p
        ...
        <div className="hidden md:block md:col-span-3 md:col-start-2 md:mt-10">
        ...
        <div className="hidden md:block md:col-span-5 md:col-start-5 md:-mt-10">
